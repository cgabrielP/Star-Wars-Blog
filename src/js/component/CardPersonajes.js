  ...
  return (
    <div className="card" >
      ...
      <div className="card-body">
        ...
        <button type="button" className="mx-2 btn btn-light" onClick={() => {actions.agregarFavoritos({uid, name, type:"personaje"}),icon==='regular'?setIcon('solid'):setIcon('regular')}}><i className={`fa-${icon} fa-heart`}></i></button>
