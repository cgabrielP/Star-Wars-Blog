        ...
        <ScrollToTop>
          <div className="d-flex flex-column vh-100">
            ...
            <Routes>
              ...
              <Route
                path="personajes/personaje/:uid/detail"
                element={<DetallePersonaje />}
              />
              <Route
                path="personaje/:uid/detail"
                element={<DetallePersonaje />}
              />
              <Route
                path="planetas/planeta/:uid/detail"
                element={<DetallePlaneta />}
              />
              <Route path="planeta/:uid/detail" element={<DetallePlaneta />} />
              <Route
                path="vehiculos/vehiculo/:uid/detail"
                element={<DetalleVehiculo />}
              />
              <Route
                path="vehiculo/:uid/detail"
                element={<DetalleVehiculo />}
              />
